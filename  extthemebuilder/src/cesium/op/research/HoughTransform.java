...
public class HoughTransform extends Thread {
    ...
    public static void main(String[] args) throws Exception {
        String filename = "D:\\download\\default\\button\\btn.gif";
        String targetFile = "D:\\download\\default\\button\\btn_target.gif";
        ...
        javax.imageio.ImageIO.write(image, "gif", new File(targetFile));
    }
